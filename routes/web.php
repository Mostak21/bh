...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/product-bulk-export', 'ProductBulkUploadController@export')->name('product_bulk_export.index');
       ...
       Route::get('/product-bulk-export-google', 'ProductBulkUploadController@export_google')->name('product_bulk_export_google.index');
    Route::get('/product-bulk-export-brand', 'ProductBulkUploadController@export_brand')->name('product_bulk_export_brand.index');
    Route::get('/product-bulk-export-single-brand', 'ProductBulkUploadController@export_single_brand')->name('product_bulk_export.single_brand');
