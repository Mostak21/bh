                                        ...
                                        @if(get_setting('cash_payment') == 1)
                                            @php
                                                ...
                                                foreach($carts as $cartItem){
													...
													if($total>2000 && $cod_status!=1){
															$cod_on= 0;
														}
													if($total>7000 && $cod_status==1){
															$cod_on= 0;
														}
                                                }
                                            @endphp
...
{{--                            partial payment start--}}
                            ...
                            <div class="col-6 col-md-4" style="display: inline-block;">
                                ...
                                <label class="aiz-megabox d-block mb-3">
                                    ...
                                    <span class="d-block p-3 aiz-megabox-elem">
                                        <img src="https://brandhook.s3.ap-south-1.amazonaws.com/uploads/all/L6NFJMfT6mY0UqhK4LJGtxvYtsLCCThJZjojlFo3.webp" class="img-fluid mb-2">
                                        <span class="d-block text-center">
...
{{--                                <label for="pam" style="font-size:20px;"><span><h3>Pay Partial Amount: {{$partial_payment}} </h3></span></label>--}} <small id="emailHelp" style="font-size:13px;" class="form-text text-muted mt-3"><b>Note* :</b> For partial payment (50% payment) pay 50% in advance & pay 50% after receive the product.</small>
