...
@endif
<!-- Top Bar -->
<div class="top-navbar bg-white border-bottom-0 border-soft-secondary z-1035">
    <div class="container">
        <div class="row">
            ...
            <div class="col-5 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    @auth
                        @if(isAdmin())
                            <li class="list-inline-item mr-3 border-right-0 border-left-0 pr-3 pl-0">
                                <a href="{{ route('admin.dashboard') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('My Panel')}}</a>
                            </li>
                        @else

                            <li class="list-inline-item mr-3 border-right-0 border-left-0 pr-3 pl-0 dropdown">
